{
  ...
  "rules": {
    ...
    "object-curly-spacing": [2, "never"], // Disallow or enforce spaces inside of curly braces in objects. ("never" by default)
    "array-bracket-spacing": [2, "never"], // Disallow or enforce spaces inside of brackets. ("never" by default)
    "computed-property-spacing": [2, "never"], // Disallow or enforce spaces inside of computed properties. ("never" by default)
